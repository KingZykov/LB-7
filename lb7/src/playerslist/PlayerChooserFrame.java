...
public class PlayerChooserFrame extends JFrame {
		...
		exitItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int option = JOptionPane.showConfirmDialog(getParent(),
						"Точно хочешь выйти?", "Подтвердить",
	...
	private JPanel createButtonsPanel() {
		...
		takeButton.setToolTipText("Добавить выделенных рестлеров");
		takeAllButton = new JButton(">>");
		takeAllButton.setToolTipText("Добавить всех рестлеров");
		returnButton = new JButton("<");
		returnButton.setToolTipText("Вернуть выделенных рестлеров");
		returnAllButton = new JButton("<<");
		returnAllButton.setToolTipText("Вернуть всех рестлеров");
